  ...
  return (
    <div className="service section">
      ...
      <div className="categories">
        <div className="card">
          <img src="icon/Group 48.svg" alt="" className="card-img" />
        ...
        <div className="card">
          <img src="icon/Group 49.svg" alt="" className="card-img" />
